...
public class MonthlyPointsResponse
{
    ...
    [JsonPropertyName("month_year")] public DateOnly MonthYear { get; set; }

    [JsonPropertyName("points_allocated")] public int PointsAllocated { get; set; }

    [JsonPropertyName("points_spent")] public int PointsSpent { get; set; }

    [JsonPropertyName("user_id")] public Guid UserId { get; set; }

    [JsonPropertyName("is_revoke")] public bool IsRevoke { get; set; }
